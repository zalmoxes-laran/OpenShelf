...
class OpenShelfPreferences(AddonPreferences):
    ...
    # Proprietà per tab selector (definita dinamicamente)
...
# Aggiunge la proprietà tab al tipo
OpenShelfPreferences.__annotations__['prefs_tab'] = OpenShelfPreferences.prefs_tab
