...
class OBJLoader:
    ...
    def import_obj(filepath: str, **kwargs) -> Optional[bpy.types.Object]:
        """
        Importa un file OBJ in Blender
        ...
        try:
            ...
            import_params = {
                'filepath': filepath,
                'use_edges': kwargs.get('use_edges', True),
                ...
                'use_groups_as_vgroups': kwargs.get('use_groups_as_vgroups', False),
                'use_image_search': kwargs.get('use_image_search', True),
                'split_mode': kwargs.get('split_mode', 'ON'),
                'global_clamp_size': kwargs.get('global_clamp_size', 0.0),
                'axis_forward': kwargs.get('axis_forward', '-Z'),
                'axis_up': kwargs.get('axis_up', 'Y'),
            }
